...
Cirv Cookie Index — an open cookie/consent (GDPR + ePrivacy) compliance signal for EU e-commerce. Static homepage analysis; a conservative signal, not a verdict, and not legal advice. <a href="/claim.html">Claim or correct a listing</a>. Built by <a href="https://cirvgreen.com">Cirvgreen</a>.
</div></footer>
<script>
(function(){
...
<p class="lead">This index is a static, homepage-only signal for GDPR and ePrivacy consent. It cannot see JavaScript-injected trackers, so it is a conservative floor, not a verdict, and not legal advice. If a listing is yours, you can claim it, ask for a correction, or request a fresh rescan. We read every message.</p>
</section>
...
form.addEventListener('submit',function(ev){
  ...
  var payload={ product:'cookie', intent:document.getElementById('intent').value, store:document.getElementById('store').value.trim(), name:document.getElementById('name').value.trim(), email:email, message:document.getElementById('message').value.trim(), source:location.href };
  ...
  return layout({
    title: 'Claim or correct your listing — Cirv Cookie Index',
    description: 'Store owners: claim your listing, request a correction or a fresh cookie/consent rescan. Static signal, not legal advice.',
...
<p class="lead">Thanks for subscribing to the Cirv Cookie Index API. Your subscription is active, and your key can now be used at the higher limit.</p></section>
...
<ul>
<li>Spot which stores or client sites may be loading trackers before consent.</li>
<li>Track consent risk after tag manager, analytics, ad, or theme changes.</li>
<li>Build internal reports for ecommerce, marketing, privacy, and agency teams.</li>
</ul>
</div>
...
<div class="value-card"><h3>For agencies</h3><p>Scan client portfolios, find risky consent setups, and turn the results into monthly privacy and ecommerce reports.</p></div>
<div class="value-card"><h3>For teams</h3><p>Monitor after tag manager, analytics, ad pixel, CMP, theme, or checkout changes so regressions do not sit unnoticed.</p></div>
</div>
...
<ul>
<li>Pull a ranked list of stores and identify who may need consent review.</li>
<li>Look up one domain and see the score, grade, failed signals, and top issue.</li>
<li>Feed cookie-consent scores into dashboards, client reports, lead scoring, or privacy QA workflows.</li>
...
<h2>FAQ</h2>
<div class="faq">
<details><summary>Is this a full legal cookie audit?</summary><p>No. It is a static homepage scan that catches common cookie and tracker signals. It helps prioritize review, but it is not legal advice or a compliance guarantee.</p></details>
<details><summary>Why should a non-developer care?</summary><p>Cookie and tracker mistakes can affect customer trust, privacy review, advertising operations, and remediation cost. The score gives business teams a simple way to see where review is needed.</p></details>
...
<details><summary>Does a high score mean we are compliant?</summary><p>No. A high score means no obvious static red flags were found on the homepage. JavaScript-injected trackers and legal consent details still need manual review.</p></details>
<details><summary>Can agencies use this for clients?</summary><p>Yes. Agencies can use it to find which client sites need consent review, support monthly reports, and show progress after fixes.</p></details>
</div>
...
<p style="margin-top:18px"><a class="btn" href="/data.json">View the open data</a> &nbsp;<span class="note">Updated ${esc(fmtDate(updated))} · CC-BY-4.0</span></p>
</section>
